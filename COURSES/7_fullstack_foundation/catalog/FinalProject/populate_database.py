...
# lets bind the engine to the base class
# and
# make the connection between class definition and their corresponding tables within our db
Base.metadata.bind = engine
# make a session maker object to establish a link between our code execution and the engine we just created
